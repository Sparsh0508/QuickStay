...
const Dashboard = () => {
  ...
  return (
    <div>
      ...
      {/* Recent Bookings */}
      <h2 className="text-xl text-blue-950/76 font-medlum mb-5 ">
        Recent Bookings
      </h2>
      <div className="w-full max-w-3x1 text-left border border-gray-300rounded-1g max-h-80 overflow-y-scroll">
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              <th className="py-3 px-4 text-gray-800 font-medium">User Name</th>
              <th className="py-3Tpx-4 text-gray-800 font-medium max-sm:hidden">
                Room Name
              </th>
