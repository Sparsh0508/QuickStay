...
const HotelReg = () => {
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 overflow-y-auto backdrop-blur-sm"
    >
      <form
      ...
      >
        <img
          src={assets.regImage}
          alt="reg-image"
          className="w-1/2 rounded-x1 hidden md:block"
        />
